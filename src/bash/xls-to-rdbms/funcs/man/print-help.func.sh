...
doPrintHelp(){
   ...
   #------------------------------------------------------------------------------
      ...
      #--------------------------------------------------------
		...
		You must specify the files to be be included in the full package from the met/xls-to-rdbms.dev 
		file
      ...
      #------------------------------------------------------------------------------
		...
		where <<full_package>> should look like: xls-to-rdbms.0.0.2.prd.20160702_181412.ysg-host-name.zip
