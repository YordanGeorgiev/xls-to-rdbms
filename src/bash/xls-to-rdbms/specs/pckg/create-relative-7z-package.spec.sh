# src/bash/xls-to-rdbms/funcs/create-relative-7z-package.spec.sh
...
doSpecCreateRelative7zPackage(){
	...
	cat doc/txt/xls-to-rdbms/specs/pckg/create-relative-7z-package.spec.txt
...
# eof file: src/bash/xls-to-rdbms/funcs/create-relative-7z-package.spec.sh
