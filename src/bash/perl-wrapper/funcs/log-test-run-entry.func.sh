# src/bash/xls-to-rdbms/funcs/log-test-run-entry.func.sh
...
doLogTestRunEntry(){
   ...
   case "$1" in
     INIT)
         # cat doc/txt/xls-to-rdbms/funcs/log-test-run-entry.func.txt
...
# eof file: src/bash/xls-to-rdbms/funcs/log-test-run-entry.func.sh
