# src/bash/xls-to-rdbms/funcs/log-test-run-entry.test.sh
...
doTestLogTestRunEntry(){
	...
	cat doc/txt/xls-to-rdbms/tests/log-test-run-entry.test.txt
...
# eof file: src/bash/xls-to-rdbms/funcs/log-test-run-entry.test.sh
