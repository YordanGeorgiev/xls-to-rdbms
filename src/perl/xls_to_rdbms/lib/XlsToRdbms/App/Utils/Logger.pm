package XlsToRdbms::App::Utils::Logger ;
   ...
   use utf8 ; 
	...
	use File::Path;
	use Data::Printer ; 
	use XlsToRdbms::App::Utils::Timer ; 
...
Perhaps a little code snippet.
    ...
    use XlsToRdbms::Control::Utils::Logger ; 

    my $objLogger = XlsToRdbms::Control::Utils::Logger->new( \$appConfig ) ;
    ...
...
=cut
	...
	sub Initialize {
		...
		$objTimer               = 'XlsToRdbms::App::Utils::Timer'->new( $appConfig->{ 'TimeFormat' } );
