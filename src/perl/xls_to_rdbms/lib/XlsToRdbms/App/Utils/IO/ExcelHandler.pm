package XlsToRdbms::App::Utils::IO::ExcelHandler ; 
   ...
   sub doBuildXlsFromHashRef {
      ...
      my $objTimer = 'XlsToRdbms::App::Utils::Timer'->new() ; 
   ...
   sub doInitialize {
      ...
      $ProductInstanceDir   = $appConfig->{ 'ProductInstanceDir' } ; 
	   $objFileHandler 	   = 'XlsToRdbms::App::Utils::IO::FileHandler'->new ( \$appConfig ) ; 
   }
